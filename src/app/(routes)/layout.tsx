...
export default function RoutesLayout({
  ...
  return (
    <main className={`flex ${menuActive ? '' : 'px-6 py-6'} justify-between`}>
      <button
      ...
      <div
        className={`h-[100vh] w-72 bg-[#121212] flex flex-col p-6 justify-between border-r border-r-[#EFEFEF]/10 ${
          menuActive ? "" : "hidden"
        }`}
      >
        <section className="flex flex-col gap-6">
          <div className="flex gap-2 items-center justify-between">
            ...
            <button className="xl:hidden text-white" onClick={() => setMenuActive(false)}>
      ...
      {children}
      <section>
        <Image src="/avatar.svg" width={56} height={56} alt="profile image" className="rounded-full" />
      </section>
    </main>
  );
}
